...
import           Nil.Field  ( Extensionfield (..), Irreduciblepoly (..),
                              Primefield (..), ef )
...
type G1
   = Primefield 21888242871839275222246405745257275088696311157297823662689037894645226208583
...
to'gt :: [G1] -> GT
to'gt = ef [82, 0, 0, 0, 0, 0, -18, 0, 0, 0, 0, 0, 1]
